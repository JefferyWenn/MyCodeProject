...
def get_average(pixels):
    ...
    # Return the list of [red, green, blue]
...
def get_best_pixel(pixels):
    ...
    best_pixel = pixels[0]
    best_dist = get_pixel_dist(pixels[0], avg_rgb[0], avg_rgb[1], avg_rgb[2])
    ...
    for x in range(width):
        for y in range(height):
            ...
            for i in range(len(images)):
                test_pixels += [images[i].get_pixel(x, y)]
            best_p = get_best_pixel(test_pixels)
